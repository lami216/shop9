...
const AdminCoupons = () => {
        ...
        const renderTableRows = () => {
                if (loading) {
                        return (
                                <tr>
                                        <td colSpan={6} className='px-4 py-6 text-center text-ali-ink'>
                                                <div className='flex items-center justify-center gap-2'>
                                                        <Loader2 className='h-5 w-5 animate-spin text-ali-ink' />
                                                        {t("common.loading")}
                                                </div>
                                        </td>
                                </tr>
                ...
                if (coupons.length === 0) {
                        return (
                                <tr>
                                        <td colSpan={6} className='px-4 py-6 text-center text-ali-muted'>
                                ...
                                <td className='px-4 py-3 text-right'>
                                        <div className='flex items-center justify-end gap-2'>
                                                <button
                                                        ...
                                                        className='inline-flex items-center gap-1 rounded-md bg-payzone-gold/10 px-3 py-1 text-sm text-ali-ink transition hover:bg-payzone-gold/20'
                                                ...
                                                <button
                                                        ...
                                                        className='inline-flex items-center gap-1 rounded-md bg-ali-card px-3 py-1 text-sm text-ali-ink transition hover:bg-ali-card disabled:opacity-60'
                                                        disabled={mutationLoading}
                                                >
                                                        {coupon.isActive ? (
                                                                <>
        ...
        return (
                <div className='rounded-xl bg-ali-card p-6 shadow-lg backdrop-blur'>
                        <div className='mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between'>
                                <div>
                                        <h2 className='text-2xl font-semibold text-ali-ink'>{t("admin.coupons.title")}</h2>
                                        <p className='text-sm text-ali-muted'>{t("admin.coupons.subtitle")}</p>
                                </div>
                                <div className='flex flex-col gap-3 sm:flex-row sm:items-center'>
                                        <div className='flex items-center rounded-lg bg-ali-card px-3 py-2 shadow-inner'>
                                                <Search className='mr-2 h-5 w-5 text-ali-ink' />
                                                <input
                                                        type='text'
                                                        value={searchTerm}
                                                        onChange={(event) => setSearchTerm(event.target.value)}
                                                        placeholder={t("admin.coupons.searchPlaceholder")}
                                                        className='w-48 bg-transparent text-sm text-ali-ink placeholder-ali-muted/80 focus:outline-none'
                                                />
                                        </div>
                                        <div className='flex items-center gap-2 rounded-lg bg-ali-card px-3 py-2 shadow-inner'>
                                                <select
                                                        value={localSortBy}
                                                        onChange={(event) => setLocalSortBy(event.target.value)}
                                                        className='bg-transparent text-sm text-ali-ink focus:outline-none'
                                                >
                                                ...
                                                <button
                                                        ...
                                                        className='rounded-md bg-payzone-gold/10 p-1 text-ali-ink transition hover:bg-payzone-gold/20'
                                                >
                                                        {localSortOrder === "asc" ? (
                        ...
                        <div className='overflow-x-auto rounded-lg bg-white shadow-inner'>
                                <table className='min-w-full divide-y divide-ali-card text-left text-sm text-ali-ink'>
                                        <thead className='bg-ali-card text-xs uppercase tracking-wider text-ali-ink'>
                                                <tr>
                                        ...
                                        <tbody className='divide-y divide-ali-card'>{renderTableRows()}</tbody>

                                </table>
                        </div>

                        <div className='mt-4 flex flex-col items-center justify-between gap-3 text-sm text-ali-ink sm:flex-row'>
                                <div>
                                ...
                                <div className='flex items-center gap-2'>
                                        <button
                                                ...
                                                className='rounded-md bg-ali-card px-3 py-1 text-ali-ink transition hover:bg-ali-card disabled:opacity-60'
                                        >
                                                {t("admin.coupons.pagination.prev")}
                                        </button>
                                        <span className='rounded-md bg-ali-card px-3 py-1 text-ali-ink'>
                                ...
                                <div className='fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4'>
                                        <div className='w-full max-w-md rounded-2xl bg-payzone-navy p-6 shadow-2xl'>
                                                <div className='mb-4 flex items-start justify-between'>
                                                        <div>
                                                                <h3 className='text-xl font-semibold text-ali-ink'>
                                                                        {editingCoupon
                                                        ...
                                                        <button
                                                                type='button'
                                                                onClick={closeForm}
                                                                className='rounded-full bg-ali-card p-2 text-ali-ink transition hover:bg-ali-card'
                                                                disabled={mutationLoading}
                                                ...
                                                <form onSubmit={handleSubmit} className='space-y-4'>
                                                        <div>
                                                                <div className='mb-1 flex items-center justify-between gap-3'>
                                                                        ...
                                                                        <button
                                                                                ...
                                                                                className='rounded-full bg-ali-card px-3 py-1 text-xs font-semibold text-ali-ink transition hover:bg-ali-card disabled:opacity-60'
                                                                ...
                                                                {isBulkMode ? (
                                                                        <>
                                                                                <textarea
                                                                                        ...
                                                                                        className='w-full rounded-lg border border-white/20 bg-ali-card px-3 py-2 text-ali-ink focus:border-payzone-gold focus:outline-none'
                                                                                />
                                                        ...
                                                        <div>
                                                                <label className='mb-1 block text-sm font-medium text-ali-ink'>
                                                        ...
                                                        <div className='flex items-center justify-between'>
                                                                <span className='text-sm text-ali-ink'>
                                                        ...
                                                        <div className='flex justify-end gap-2 pt-2'>
                                                                <button
                                                                        type='button'
                                                                        onClick={closeForm}
                                                                        className='rounded-lg bg-ali-card px-4 py-2 text-sm font-semibold text-ali-ink transition hover:bg-ali-card disabled:opacity-60'
                                                                        disabled={mutationLoading}
                                                                >
